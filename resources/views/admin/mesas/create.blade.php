...
@section('title', 'Nueva Mesa - TuSabor')
...
<div class="mb-4">
    ...
    <h1 class="h2 text-borgona"><i class="fas fa-chair me-2"></i>Nueva Mesa</h1>
</div>
        ...
        <form action="{{ route('admin.mesas.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="ubicacion" 
                    ...
                    <option value="interior" {{ old('ubicacion') == 'interior' ? 'selected' : '' }}>
                        Interior
                    </option>
                    <option value="terraza" {{ old('ubicacion') == 'terraza' ? 'selected' : '' }}>
                        Terraza
                    </option>
                    <option value="vip" {{ old('ubicacion') == 'vip' ? 'selected' : '' }}>
                        VIP
                    </option>
                </select>
                @error('ubicacion')
