...
@section('title', 'Nuevo Producto - TuSabor')
...
<div class="mb-4">
    ...
    <h1 class="h2 text-borgona"><i class="fas fa-utensils me-2"></i>Nuevo Producto</h1>
</div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descripcion" 
                                  ...
                                  rows="4"
                                  placeholder="Describe el producto, ingredientes, etc.">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
